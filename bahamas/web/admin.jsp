                    ...
                    <div class="navbar-custom-menu">                        
                        <ul class="nav navbar-nav">
                                    ...
                                    <li>
                                        ...
                                        <ul class="menu">
                                            <li><!-- start message -->
                                                <a href="#">
                                                    <div class="pull-left">
                                                        <img src="style/img/huxley.png" class="img-circle" alt="User Image">
                                                    </div>
                                                    <h4>
                                                        Support Team
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="style/img/huxley.jpg" class="user-image" alt="User Image">
                                    <span class="hidden-xs"><%out.println("Welcome " + name);%></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <!-- User image -->
                                    <li class="user-header">
                                        <img src="style/img/huxley.jpg" class="img-circle" alt="User Image">
                                        <p>
                                            <%out.println(name + " - " + position.toUpperCase());%>
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        ...
                        <div class="pull-left info">
                            <p><a href="admin.jsp"><%out.println(name);%></p>
                            <%out.print(position.toUpperCase());%></a>
                        </div>    
                    </div>                   
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-group"></i> <span>Contact</span> <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu" style="padding: 10px">                    
                                <li style="padding-top: 5px">
                                    <form action="#" method="get" class="sidebar-form">
                                        <div class="input-group">
                                            <input type="text" name="searchContact" class="form-control" placeholder="Search for contact...">
                                            <span class="input-group-btn">
                                                <button type="submit" name="contactSrch" id="search-btn" class="btn btn-flat"><i class="fa fa-search"></i>
                                                </button>
                                            </span>
                                        </div>
                                    </form>
                                </li>
                                <li><a href="javascript: void(0)"><i class="fa fa-user-plus"></i><span> Create New Contact</span></a></li>
                            </ul>
                        </li>
                        <!-- Event information -->
                        <li class="treeview">
