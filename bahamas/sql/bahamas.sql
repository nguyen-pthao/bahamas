...
CREATE TABLE `EVENT` (
  ...
  `EVENT_LOCATION_LONGITUDE` varchar(100) NOT NULL,
  `EVENT_LOCATION_LATITUDE` varchar(100) DEFAULT NULL,
  `REMARKS` varchar(1000) DEFAULT NULL,
  `CONTACT_ID` int(11) NOT NULL,
  PRIMARY KEY (`EVENT_ID`),
  CONSTRAINT `EVENT_FK1` FOREIGN KEY (`CONTACT_ID`) REFERENCES `CONTACT` (`CONTACT_ID`) ON DELETE CASCADE
...
CREATE TABLE `EVENT_CLASS_LIST` (
  `EVENT_CLASS_NAME` varchar(50) NOT NULL,
  `POSITION_NUMBER` int(11) DEFAULT '0',
...
--
-- Table structure for table `EVENT_STATUS_LIST`
--
...
CREATE TABLE `TRAINING_CERTIFICATED` (
  ...
  `TEAM_NAME` varchar(50) NOT NULL,
  `EXPLAIN_IF_OTHER` varchar(200) DEFAULT NULL,
  `TRAINING_COURSE` varchar(50) DEFAULT NULL,
  `TRAINING_BY` varchar(50) DEFAULT NULL,
  `TRAINING_DATE` date DEFAULT NULL,
  `REMARKS` varchar(1000) DEFAULT NULL,
  PRIMARY KEY (`CERTIFICATION_ID`),
  KEY `TRAINING_CERTIFICATED_FK1` (`CONTACT_ID`),
  CONSTRAINT `TRAINING_CERTIFICATED_FK1` FOREIGN KEY (`CONTACT_ID`) REFERENCES `CONTACT` (`CONTACT_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-07-29 16:03:35
