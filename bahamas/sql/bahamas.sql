...
REMARKS VARCHAR(1000),
CONSTRAINT OFFICE_HELD_PK PRIMARY KEY(CONTACT_ID,OFFICE_HELD_NAME,START_OFFICE),
...
MEMBERSHIP_ID INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY,
CONTACT_ID INTEGER NOT NULL,
DATE_CREATED DATETIME NOT NULL,
CREATED_BY VARCHAR(50) NOT NULL,
EXPLAIN_IF_OTHER_CLASS VARCHAR(200),
...
CONSTRAINT TEAM_JOIN_PK PRIMARY KEY(CONTACT_ID,TEAM_NAME),
