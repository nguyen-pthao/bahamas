...
CONSTRAINT PERIOD_FK1 FOREIGN KEY(CONTACT_ID) REFERENCES CONTACT(CONTACT_ID) ON DELETE CASCADE
...
CONSTRAINT PROXY_FK1 FOREIGN KEY(CONTACT_ID) REFERENCES CONTACT(CONTACT_ID) ON DELETE CASCADE,
CONSTRAINT PROXY_FK2 FOREIGN KEY(PROXY_ID) REFERENCES CONTACT(CONTACT_ID) ON DELETE CASCADE
) CHARACTER SET = utf8;
...
CONSTRAINT MEMBERSHIP_FK1 FOREIGN KEY(CONTACT_ID) REFERENCES CONTACT(CONTACT_ID) ON DELETE CASCADE
...
REMARKS VARCHAR(1000),
CONSTRAINT DONATION_FK1 FOREIGN KEY(CONTACT_ID) REFERENCES CONTACT(CONTACT_ID) ON DELETE CASCADE
...
REMARKS VARCHAR(1000),
CONSTRAINT APPRECIATION_FK1 FOREIGN KEY(CONTACT_ID) REFERENCES CONTACT(CONTACT_ID) ON DELETE CASCADE
) CHARACTER SET = utf8;
...
REMARKS VARCHAR(1000),
CONSTRAINT TRAINING_CERTIFICATED_FK1 FOREIGN KEY(CERTIFIED_BY) REFERENCES CONTACT(CONTACT_ID) ON DELETE CASCADE,
CONSTRAINT TRAINING_CERTIFICATED_FK2 FOREIGN KEY(TRAINING_COURSE) REFERENCES EVENT(EVENT_ID) ON DELETE CASCADE
) CHARACTER SET = utf8;
...
CONSTRAINT EVENT_ROLE_ASSIGNMENT_FK2 FOREIGN KEY(EVENT_ID) REFERENCES EVENT(EVENT_ID) ON DELETE CASCADE
) CHARACTER SET = utf8;
...
CONSTRAINT EVENT_PARTICIPANT_FK1 FOREIGN KEY(CONTACT_ID) REFERENCES CONTACT(CONTACT_ID) ON DELETE CASCADE,
CONSTRAINT EVENT_PARTICIPANT_FK2 FOREIGN KEY(AWARDER_ID) REFERENCES CONTACT(CONTACT_ID) ON DELETE CASCADE,
#CONSTRAINT EVENT_PARTICIPANT_FK3 FOREIGN KEY(ROLE_ID) REFERENCES ROLE_LIST(ROLE_ID),
CONSTRAINT EVENT_PARTICIPANT_FK4 FOREIGN KEY(EVENT_ID) REFERENCES EVENT(EVENT_ID) ON DELETE CASCADE
) CHARACTER SET = utf8;
...
CONSTRAINT EVENT_AFFILIATION_FK1 FOREIGN KEY(EVENT_ID) REFERENCES EVENT(EVENT_ID) ON DELETE CASCADE
...
STATUS VARCHAR(10),
CONSTRAINT NOTICE_FK1 FOREIGN KEY(EVENT_ID) REFERENCES EVENT(EVENT_ID) ON DELETE CASCADE
) CHARACTER SET = utf8;
