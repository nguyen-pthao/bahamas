 ...
 * @author HUXLEY
 */
@WebServlet(name = "DeleteTraining", urlPatterns = {"/training.delete"})
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (jsonLine == null || jsonLine.isEmpty()) {
                ...
                if (username == null) {
                    ...
                    if (TrainingDAO.deleteTraining(training_id)) {
                        AuditLogDAO.insertAuditLog(username, "DELETE TRAINING", "Delete training under training: Training ID: " + training_id);
