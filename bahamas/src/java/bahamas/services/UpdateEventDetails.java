 ...
 * @author tan.si.hao
 */
@WebServlet(name = "UpdateEventDetails", urlPatterns = {"/event.updatedetails"})
                ...
                if (username == null) {
                    ...
                    if (contact == null) {
                        ...
                        if (contact.isIsAdmin() || RoleCheckDAO.checkRole(contact.getContactId(), "teammanager") || RoleCheckDAO.checkRole(contact.getContactId(), "eventleader")) {
                            ...
                            //check if exist
                            Event event = new Event(Integer.parseInt(eventId), eventStartDate, eventEndDate, eventTimeStart, eventTimeEnd, eventTitle, address, zipcode, eventDescription, Integer.parseInt(minimumParticipation), sendReminder, eventClass, eventLocation, eventLat, eventLng, eventStatus, remarks, reminderEmail);
