            ...
            if (jsonLine == null || jsonLine.isEmpty()) {
                ...
                if (username == null) {
                    ...
                    while (iter.hasNext()) {
                        ...
                        store.addProperty("Date/Time stamp", temp.get(0));
                        store.addProperty("Authentication code", temp.get(1));
                        store.addProperty("Contact ID", temp.get(2));
                        store.addProperty("Name", temp.get(3));
                        store.addProperty("NRIC", temp.get(4));
                        store.addProperty("First Checkbox", temp.get(5));
                        store.addProperty("Second Checkbox", temp.get(6));
