        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (jsonLine == null || jsonLine.isEmpty()) {
                ...
                if (username == null) {
                    ...
                    //Verified token
                    int contactId = jobject.get("contact-id").getAsInt();
                    ContactDAO cDAO = new ContactDAO();
                    
                    int countryCode = jobject.get("country-code").getAsInt();
                    int phoneNumber = jobject.get("phone-number").getAsInt();
                    String phoneRemarks = jobject.get("phone-remarks").getAsString();

                    Phone newPhone = new Phone(cDAO.retrieveContactById(contactId), countryCode, phoneNumber, phoneRemarks);
