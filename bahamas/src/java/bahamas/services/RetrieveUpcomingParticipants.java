 ...
 * @author tan.si.hao
 */
@WebServlet(urlPatterns = {"/event.upcomingparticipants"})
public class RetrieveUpcomingParticipants extends HttpServlet {
                            ...
                            for (int i = 0; i < eventList.size(); i++) {
                                ...
                                try {
                                    ...
                                    if (eventEndDate.after(currentDate) || (eventEndDate.equals(currentDate) && eventEndTime.after(currentTime))) {
                                        ...
                                        jsonContactObj.addProperty("event_title", event.getEventTitle() + ", " + event.getEventLocationName());
