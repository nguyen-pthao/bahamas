 ...
 * @author HUXLEY
 */
@WebServlet(name = "AddOfficeHeld", urlPatterns = {"/officeheld.add"})
public class AddOfficeHeld extends HttpServlet {
            ...
            if (jsonLine == null || jsonLine.isEmpty()) {
                ...
                if (username == null) {
                    ...
                    if (c == null) {
                        ...
                        if (startOffice != null && endOffice != null) {
                            if (endOffice.before(startOffice) || !startOffice.before(endOffice)) {
                        ...
                        if (OfficeHeldDAO.addOfficeHeld(o)) {
                            AuditLogDAO.insertAuditLog(username, "ADD OFFICE HELD", "Add office held under contact: Contact ID: " + c.getContactId());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AddOfficeHeld.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
