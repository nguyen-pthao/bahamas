 ...
 * @author HUXLEY
 */
@WebServlet(name = "AddTraining", urlPatterns = {"/training.add"})
            ...
            if (jsonLine == null || jsonLine.isEmpty()) {
                ...
                if (username == null) {
                    ...
                    if (c == null) {
                        ...
                        Training newTraining = new Training(c,username,teamName,explainIfOther,trainingCourse,trainingBy,trainingDate,remarks);
                                
                        if (TrainingDAO.addTraining(newTraining)) {
                            AuditLogDAO.insertAuditLog(username, "ADD TRAINING", "Add training under contact: Contact ID: " + c.getContactId());                        
