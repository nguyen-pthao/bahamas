...
public class RetrieveUpcomingJoinedEventsHomePage extends HttpServlet {
                        ...
                        if (eventList != null) {
                            ...
                            for (int i = 0; i < eventList.size(); i++) {
                                ...
                                try {
                                    ...
                                    Logger.getLogger(RetrieveUpcomingJoinedEventsHomePage.class.getName()).log(Level.SEVERE, null, ex);
                                }
                            }
